...
:new: **AI Playground 3.0.2 beta (all SKUs)** - [Release Notes](https://github.com/intel/AI-Playground/releases/download/v3.0.3-beta/AI-Playground-installer.exe) | [Download](https://github.com/intel/AI-Playground/releases/download/v3.0.3-beta/AI-Playground-installer.exe) :new:
