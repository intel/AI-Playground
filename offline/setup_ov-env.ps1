...
$serviceDir = Join-Path $resourceDir "OpenVINO"
$envDir = Join-Path $resourceDir "openvino-env"

$offlineDir = $scriptDir
$wheelsDir = Join-Path $offlineDir "wheels\openvino"
...
function Initialize-EnvironmentDirectory {
    # copy folder $resourceDir\prototype-python-env to $resourceDir\openvino-env
