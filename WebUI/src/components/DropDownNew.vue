...
<template>
  <DropdownMenu>
    <DropdownMenuTrigger as-child>
      <button>
        <div class="w-full h-[30px] rounded-[15px] bg-[#05010f] border border-[#cdcdcd] text-white px-3 flex items-center justify-between">
    ...
    <DropdownMenuContent class="w-full rounded-lg p-[3px] border border-[#cdcdcd] bg-[#05010f] max-h-[188px] overflow-y-auto z-[100] ml-4">
      <DropdownMenuLabel v-if="title" class="text-white px-3 py-2 text-sm font-medium">{{ title }}</DropdownMenuLabel>
