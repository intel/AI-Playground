<template>
  ...
  >
    <div
      ...
      :class="imageGeneration.selectedEditedImageId === image.id ? 'border-blue-500' : 'border-transparent'"
      @click="imageGeneration.selectedEditedImageId = image.id"
    >
      <div
...
const nonQueuedImages = computed(() =>
  imageGeneration.generatedImages.filter((i) => i.state !== 'queued' && i.mode === 'imageEdit')
)
