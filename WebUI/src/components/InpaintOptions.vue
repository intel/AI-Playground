<template>
  <div
    ...
    :class="{ 'demo-mode-inpaint-content': demoMode.enabled && demoMode.enhance.showInpaint }"
  >
    ...
    <div v-if="demoMode.enabled && demoMode.enhance.showInpaint" class="demo-step-number">3</div>
  </div>
</template>
