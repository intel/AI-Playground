    ...
    <div class="flex justify-center gap-8 h-full text-white">
        <div class="flex items-center gap-5 flex-none">
            ...
            <div class="flex items-center gap-2">
                <radio-block :checked="paintType == 1" :text="languages.ENHANCE_INPAINT_FIX"
                    @click="updateType(1)"></radio-block>
                <radio-block :checked="paintType == 0" :text="languages.ENHANCE_INPAINT_FILL"
                    @click="updateType(0)"></radio-block>
            </div>
        </div>
        <div class="flex items-center gap-5 flex-none">
