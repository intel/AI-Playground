<template>
    <div>
        ...
        <div class="gap-3 w-80 flex-wrap grid grid-cols-2">
            <radio :checked="scale == 0" :text="languages.ENHANCE_UPSCALE_SCALE_X1_5" @click="changeScale(0)"></radio>
            <radio :checked="scale == 1" :text="languages.ENHANCE_UPSCALE_SCALE_X2_0" @click="changeScale(1)"></radio>
        </div>
    </div>
    <div>
