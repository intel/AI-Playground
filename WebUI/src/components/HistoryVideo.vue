<template>
  ...
  >
    <div
      ...
      :class="imageGeneration.selectedVideoId === image.id ? 'border-blue-500' : 'border-transparent'"
      @click="imageGeneration.selectedVideoId = image.id"
    >
      <div
...
const nonQueuedImages = computed(() =>
  imageGeneration.generatedImages.filter((i) => i.state !== 'queued' && i.mode === 'video')
)
