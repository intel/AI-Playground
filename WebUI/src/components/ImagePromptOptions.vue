<template>
  <div
    :class="{
      'demo-mode-image-content': demoMode.enhance.showPrompt,
      'demo-number-overlay': demoMode.enhance.showPrompt,
    }"
  >
    ...
    <div v-if="demoMode.enhance.showPrompt" class="demo-step-number">2</div>
  </div>
</template>
