<template>
  <div id="createPanel" class="h-full flex flex-col p-4">
    ...
    <div
      ...
      :class="{ 'demo-number-overlay': demoMode.enabled && demoMode.create.show }"
    >
      <textarea
        ...
        :class="{ 'demo-mode-overlay-content': demoMode.enabled && demoMode.create.show }"
      ></textarea>
      <div v-if="demoMode.enabled && demoMode.create.show" class="demo-step-number">1</div>
      <button
