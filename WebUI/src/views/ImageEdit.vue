...
onMounted(() => {
  promptStore.registerSubmitCallback('imageEdit', generateImage)
  promptStore.registerCancelCallback('imageEdit', stopGeneration)
})

onUnmounted(() => {
  promptStore.unregisterSubmitCallback('imageEdit')
  promptStore.unregisterCancelCallback('imageEdit')
})
